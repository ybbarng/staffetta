...
#define GPIO_PxDIR P6DIR
#define GPIO_PxOUT P6OUT
#define GPIO_CONF_RED    0x01   //0
#define GPIO_CONF_GREEN  0x02   //1
#define GPIO_CONF_YELLOW 0x04   //2
